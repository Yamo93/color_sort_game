export function validateSelect(stacks, target) {
    const stack = stacks.at(target);
    if (!stack) {
        throw new Error("Stack at index " + target + " is missing");
    }
}
export function validateMove(stacks, selectedStack, index) {
...
export function validateLoss(stacks) {
...
export function validateWin(stacks) {
